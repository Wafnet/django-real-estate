...
class Profile(TimeStampedModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_("phone Number"), max_length=20, default="+254724238891")
    ...
    city = models.CharField(verbose_name=_("City"), max_length=100, default="Nairobi", blank=True, null=True)
    ...
    is_agent = models.BooleanField(verbose_name=_("Is Agent"), default=False, help_text=_("Are you a Real Estate Agent?"))
