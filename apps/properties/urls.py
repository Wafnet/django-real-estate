...
urlpatterns = [
    path("all", views.ListAgentPropertiesAPIView.as_view(), name="all-properties"),
    path(
        "agents/", views.ListAgentPropertiesAPIView.as_view(), name="agent-properties"
    ),
